...
const ar = {
  ...
  venues: {
    ...
    namesTitle: "وجهات نرتّب فيها وصولًا خاصًا في الساحل والقاهرة",
    tickerSahel: "الساحل الشمالي",
    tickerCairo: "القاهرة",
    namesNote:
      "نرتّب ترابيزات في أرقى البيتش كلوبز والروفتوبات والنوادي الليلية في القاهرة والساحل. سهرة كونسييرج مستقل وغير تابع لهذه الأماكن؛ الأسماء التجارية ملك أصحابها وتُذكر للتوضيح فقط.",
    metaTitle: "سهرات فاخرة في مصر · روفتوب وبيتش وVIP | سهرة",
    metaDescription:
      "وصول حصري لروفتوبات، مراكب، بيتش كلوبز وترابيزات VIP — رتّب ليلتك عبر كونسييرج سهرة على الواتساب.",
  ...
  gallery: {
    ...
    lede: "لقطات من تجارب رتّبناها لعملائنا في القاهرة والساحل والجونة وشرم الشيخ.",
  ...
  home: {
    ...
    teaserAccent: "باسمك.",
    teaserLede:
      "من روفتوب على النيل إلى بيتش كلوب في الساحل، ومن إقامة هادئة إلى طاولة VIP — اختار المزاج… وإحنا نرتّب الوصول والتنسيق.",
    cards: [
      {
        href: "venues",
        tag: "سهرات",
        title: "روفتوب · مركب · VIP",
        body: "وصول حصري لأماكن مطلوبة في القاهرة والساحل — ترابيزات منتقاة، مواقع مميزة، وتنسيق يليق بضيوفك.",
        cta: "استكشف السهرات",
      },
      {
        href: "beaches",
